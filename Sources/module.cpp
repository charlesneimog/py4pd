...
static PyObject *Py4pdMod_AccumObjVar(PyObject *self, PyObject *args) {
    ...
    x->pdcollect->items[Py4pdMod_HashFunction(x->pdcollect, key)]->aCumulative = 1;
    free(key);
    Py_RETURN_TRUE;
}
...
// =================================
/**
 * @brief Add a thing to the send in some onset
 */
static PyObject *Py4pdMod_AddThingToSend(PyObject *self, PyObject *args) {
    (void)self;
